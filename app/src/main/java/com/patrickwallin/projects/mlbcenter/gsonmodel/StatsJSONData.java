...
public class StatsJSONData {
    ...
    @SerializedName("OpponentsLeftOnBase")
    @Expose
    private BasicStatsInfoJSONData opponentsLeftOnBase;
    @SerializedName("OpponentAtBats")
    @Expose
    private BasicStatsInfoJSONData opponentAtBats;
    ...
    @SerializedName("DefenceEfficiencyRatio")
    @Expose
    private BasicStatsInfoJSONData defenceEfficiencyRatio;
    ...
    @Expose
    private BasicStatsInfoJSONData gamesBack;
    @SerializedName("RunsFor")
    @Expose
    private BasicStatsInfoJSONData runsFor;
    @SerializedName("RunsAgainst")
    @Expose
    private BasicStatsInfoJSONData runsAgainst;
    @SerializedName("RunDifferential")
    @Expose
    private BasicStatsInfoJSONData runDifferential;
    ...
    public BasicStatsInfoJSONData getOpponentsLeftOnBase() {
        return opponentsLeftOnBase;
    }

    public void setOpponentsLeftOnBase(BasicStatsInfoJSONData opponentsLeftOnBase) {
        this.opponentsLeftOnBase = opponentsLeftOnBase;
    }

    public BasicStatsInfoJSONData getOpponentAtBats() {
        return opponentAtBats;
    }

    public void setOpponentAtBats(BasicStatsInfoJSONData opponentAtBats) {
    ...
    public BasicStatsInfoJSONData getDefenceEfficiencyRatio() {
        return defenceEfficiencyRatio;
    }

    public void setDefenceEfficiencyRatio(BasicStatsInfoJSONData defenceEfficiencyRatio) {
        this.defenceEfficiencyRatio = defenceEfficiencyRatio;
    }
    ...
    public BasicStatsInfoJSONData getGamesBack() {
        return gamesBack;
    }

    public void setGamesBack(BasicStatsInfoJSONData gamesBack) {
        this.gamesBack = gamesBack;
    }

    public BasicStatsInfoJSONData getRunsFor() {
        return runsFor;
    }

    public void setRunsFor(BasicStatsInfoJSONData runsFor) {
        this.runsFor = runsFor;
    }

    public BasicStatsInfoJSONData getRunsAgainst() {
        return runsAgainst;
    }

    public void setRunsAgainst(BasicStatsInfoJSONData runsAgainst) {
        this.runsAgainst = runsAgainst;
    }

    public BasicStatsInfoJSONData getRunDifferential() {
        return runDifferential;
    }

    public void setRunDifferential(BasicStatsInfoJSONData runDifferential) {
